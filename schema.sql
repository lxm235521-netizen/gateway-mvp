...
CREATE TABLE IF NOT EXISTS logical_models (
    ...
    status TINYINT DEFAULT 1,
    remark TEXT NULL,
    optimize_prompt TINYINT NOT NULL DEFAULT 0,
    optimizer_base_url VARCHAR(1024) NULL,
    optimizer_api_key TEXT NULL,
    optimizer_model VARCHAR(255) NOT NULL DEFAULT 'h3-prompt-writing',
    optimizer_system_prompt TEXT NULL,
    optimizer_json_mode TINYINT NOT NULL DEFAULT 1,
    optimizer_timeout_ms INT NOT NULL DEFAULT 120000,
    optimizer_send_media VARCHAR(255) NOT NULL DEFAULT 'image',
    optimizer_allow_http TINYINT NOT NULL DEFAULT 0,
    optimizer_debug TINYINT NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS async_tasks (
    ...
    original_prompt LONGTEXT NULL,
    optimized_prompt LONGTEXT NULL,
    prompt_optimizer_meta TEXT NULL,
